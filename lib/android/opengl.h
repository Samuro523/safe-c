...
typedef char  GLchar;
typedef int2  GLshort;
typedef int4  GLint;
typedef int4  GLsizei;
typedef uint4 GLenum;
typedef uint4 GLuint;
typedef uint4 GLbitfield;
typedef uint4 GLsizeiptr;
typedef float4 GLfloat;
...
[extern "libGLESv3.so"]
void glShaderSource (GLuint shader, GLsizei count, GLchar** str, GLint *length);
...
[extern "libGLESv3.so"]
void glVertexAttribPointer (GLuint index, GLint size, GLenum type, GLint normalized, GLuint stride, uint offset);
...
[extern "libGLESv3.so"]
void glBufferData (GLenum target, GLsizeiptr size, byte* data, GLenum usage);
...
[extern "libGLESv3.so"]
void glDrawElements (GLenum mode, GLsizei count, GLenum type, byte* indices);
...
const GLint GL_REPEAT                 =       0x2901;
const GLint GL_CLAMP_TO_EDGE          =        0x812F;

const GLenum GL_TEXTURE_MAG_FILTER     =        0x2800;
const GLenum GL_TEXTURE_MIN_FILTER     =        0x2801;

const GLint GL_LINEAR_MIPMAP_LINEAR   =        0x2703;
const GLint GL_LINEAR                 =        0x2601;


[extern "libGLESv3.so"]
void glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, byte *pixels);
...
[extern "libGLESv3.so"]
void glStencilFuncSeparate (GLenum face, GLenum func, GLint rf, GLuint mask);
...
[extern "libGLESv3.so"]
void glBlendFunci (GLint buf, GLenum sfactor, GLenum dfactor);

[extern "libGLESv3.so"]
void glBlendEquationi (GLint buf, GLenum mode);
...
[extern "libGLESv3.so"]
void glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, byte* pixels);
...
[extern "libGLESv3.so"]
void glReadPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, byte *pixels);
