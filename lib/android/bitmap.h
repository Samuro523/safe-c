...
//enum AndroidBitmapFormat 
    /** No format. */
const int ANDROID_BITMAP_FORMAT_NONE      = 0;
    /** Red: 8 bits, Green: 8 bits, Blue: 8 bits, Alpha: 8 bits. **/
const int ANDROID_BITMAP_FORMAT_RGBA_8888 = 1;
    /** Red: 5 bits, Green: 6 bits, Blue: 5 bits. **/
const int ANDROID_BITMAP_FORMAT_RGB_565   = 4;
    /** Deprecated in API level 13. Because of the poor quality of this configuration, it is advised to use ARGB_8888 instead. **/
const int ANDROID_BITMAP_FORMAT_RGBA_4444 = 7;
    /** Alpha: 8 bits. */
const int ANDROID_BITMAP_FORMAT_A_8       = 8;
    /** Each component is stored as a half float. **/
const int ANDROID_BITMAP_FORMAT_RGBA_F16  = 9;
    /** Red: 10 bits, Green: 10 bits, Blue: 10 bits, Alpha: 2 bits. **/
const int ANDROID_BITMAP_FORMAT_RGBA_1010102 = 10;
 ...
 */
typedef [callback]  bool (*AndroidBitmap_CompressWriteFunc)(void* userContext,
                                                const void* data,
